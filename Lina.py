...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await idk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await ydk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await wdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await hdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await sdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await adk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await bdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await cdk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await ddk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
            await edk(functions.channels.JoinChannelRequest(channel="@sm_on_top"))
...
print(text)
print("")
print("SMEX! Lina Multi Spam Bot Started Sucessfully.")
